...
The Zulu installation script is pulled from https://github.com/Azure/azure-quickstart-templates/tree/master/101-Windows-Java-ZuluOpenJDK/zulu-install.sh
